...
export const CsrfCookieApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async sanctum(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await CsrfCookieApiAxiosParamCreator(configuration).sanctum(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CsrfCookieApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        sanctum(options?: any): AxiosPromise<void> {
            return CsrfCookieApiFp(configuration).sanctum(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class CsrfCookieApi extends BaseAPI {
    ...
    public sanctum(options?: any) {
        return CsrfCookieApiFp(this.configuration).sanctum(options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const UsersApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async changeInputFlg(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
            const localVarAxiosArgs = await UsersApiAxiosParamCreator(configuration).changeInputFlg(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async changeLoginFlg(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
            const localVarAxiosArgs = await UsersApiAxiosParamCreator(configuration).changeLoginFlg(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const UsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        changeInputFlg(options?: any): AxiosPromise<User> {
            return UsersApiFp(configuration).changeInputFlg(options).then((request) => request(axios, basePath));
        },
        /**
         * ログイン済フラグ更新
         * @summary No.11 本日のログイン済フラグ更新
        ...
        changeLoginFlg(options?: any): AxiosPromise<User> {
            return UsersApiFp(configuration).changeLoginFlg(options).then((request) => request(axios, basePath));
        },
        /**
         * パスワード変更処理
         * @summary No.10 パスワード変更
...
export class UsersApi extends BaseAPI {
    ...
    public changeInputFlg(options?: any) {
        return UsersApiFp(this.configuration).changeInputFlg(options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public changeLoginFlg(options?: any) {
        return UsersApiFp(this.configuration).changeLoginFlg(options).then((request) => request(this.axios, this.basePath));
    }
